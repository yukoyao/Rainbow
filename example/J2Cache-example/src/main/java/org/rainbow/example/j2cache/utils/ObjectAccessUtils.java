package org.rainbow.example.j2cache.utils;
...
public class ObjectAccessUtils {
   ...
   * 以字段路径形式访问对象
   * <br>
   * 字段路径支持所有常见访问场景。比如：<br> address.id <br> detailList[0].name <br> payInfo.payMethodList[0].name <br> 0.text <br>
   * data.address.city.text <br> ?0.text <br> detailList[?2].name <br> data.address?.city?.text <br>
   *
   ...
   * @throws IllegalAccessException 当无法访问对象或者字段时触发
   */
  public static <T> T get(Object target, String fieldPath, Class<T> clazz, String delimiter)
   ...
   * @throws IllegalAccessException 当无法访问对象或者字段时触发
   */
  public static <T> T get(Object target, String fieldPath, Class<T> clazz, String delimiter, String nullText)
      throws IllegalAccessException {
    if (target == null) {
   ...
   */
  private static Object getValue(Object targetElement, FieldAccessDescriptor fieldAccessDescriptor)
      throws IllegalAccessException {
    Object valueElement;
